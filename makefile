...
LFLAGS = -L/opt/intel/mkl/lib/intel64/ -lmkl_intel_ilp64 -lmkl_core -lpthread -lmkl_sequential -lm -std=gnu++0x -lstdc++ -Wall -Wextra -Wformat=2 -lmpi -g -pg #..Compiler flag for MKL
#.. add above: -O2
CFLAGS = 
